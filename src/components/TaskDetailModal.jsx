...
const TaskDetailModal = ({ task, onClose }) => {
    const { updateTask, deleteTask, subjects, addSubject, tags: globalTags, addTag } = useTasks();
                            ...
                            <div>
                                ...
                                {isCreatingSubject ? (
                                    <input
                                        ...
                                        className="w-full bg-[#27272a] border border-indigo-500/50 rounded-xl px-4 py-2.5 text-white focus:border-indigo-500 outline-none placeholder:text-gray-600 font-medium"
                                        autoFocus
                                    />
                                ) : (
                                    <select
